...
function Qn(e) {
    for(var r = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$portofolio$2f$portofolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"](e.byteLength), t = new Uint8Array(e), a = 0; a < r.length; ++a)r[a] = t[a];
    return r;
}
function Ee(e, r) {
    if (!e) throw r;
